...
#
# Created: Fri Aug  9 11:57:47 2019
...
class Ui_InstallDialog(object):
    ...
    def retranslateUi(self, InstallDialog):
        ...
        self.chkRstbGuess.setText(QtWidgets.QApplication.translate("InstallDialog", "Estimate complex RSTB values", None, -1))
        self.chkEnableDeepMerge.setText(QtWidgets.QApplication.translate("InstallDialog", "Deep merge (experimental)", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("InstallDialog", "Deep merge attempts to merge changes made to individual AAMP files. This can be a powerful tool to resolve conflicts but might cause unexpected bugs or issues. ", None, -1))

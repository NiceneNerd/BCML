...
You *can* put BCML elsewhere if you want. You'll just need to specify the `graphicPacks`
...
optional arguments:
  ...
  * `--shrink`: By default, BCML will ignore files with equal or smaller sizes to what was originally in the RSTB. This option forces it to update anyway.
  ...
  * `--priority`: This specifies the load priority of the mod. By default, mods start with a priority of 100 and go up by 1 for each installation.